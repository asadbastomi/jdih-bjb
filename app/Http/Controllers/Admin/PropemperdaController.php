...
class PropemperdaController extends Controller
{
    ...
    {
        $this->data['title'] = 'Propemperda';
        $this->data['module'] = 'propemperda';
        ...
        $this->data['field'] = "['nomor', 'raperda', 'tahun', 'file', 'tanggal_diundangkan', 'usulan']";
        $this->data['yearstart'] = 2015;
        return view('admin.propemperda.index', $this->data);
    }
}
