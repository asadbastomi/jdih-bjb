...
class PenghargaanV2Controller extends Controller
{
    private $data;
    ...
    {
        $this->data['title'] = 'PenghargaanV2';
        $this->data['module'] = 'penghargaanV2';
        ...
        $this->data['field'] = "['pertanyaan', 'jawaban']";
        return view('admin.penghargaanV2.index', $this->data);
    }
}
