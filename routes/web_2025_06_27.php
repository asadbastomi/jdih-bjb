...
Route::get('/kegiatan/cat/{kategori}', 'PublicController@kegiatan')->name('kegiatan');
...
Route::get('/home/{$}/1/all/01 Tahun 2000', 'PublicController@sync')->name('sync');
// Admin
