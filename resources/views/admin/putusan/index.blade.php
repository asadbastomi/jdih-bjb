                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control send" id="tahun"
                                        placeholder="contoh: 2023" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control send" id="penandatangan" placeholder=""
                                        required>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 send" name="kategori_id" id="kategori_id"
                                        ...
                                        <option value="4">Pengadilan Negeri</option>
                                        <option value="5">Pengadilan Tata Usaha Negara</option>
                                    </select>
                                </div>
                            </div>
                        </div>
