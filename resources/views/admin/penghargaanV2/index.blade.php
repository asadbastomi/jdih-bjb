@extends('layouts.detached', ['title' => 'Penghargaan'])
    ...
    <div id="modalform" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form id="formpenghargaan" class="async">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control send" id="nama" placeholder="Nama">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="wysiwyg send" id="detail" data-type="send"></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" data-plugins="dropify"
                                        ...
                                        accept="image/x-png,image/jpg,image/jpeg,/image/webp" class="dropify send" id="foto"
                                        multiple />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="ladda-button btn btn-primary waves-effect waves-light" dir="ltr"
                            data-style="zoom-in" id="btnpenghargaan"><i class="mdi mdi-content-save mr-2"></i>
                            Save changes</button>
                    </div>
                </form>
            </div>
...
@section('script')
    ...
    <script>
        ...
        $('.dropify').dropify();
        $(function ($) {
            loadTable('{{ route('api.penghargaanV2.fetch') }}', textserach);
            ...
            $(document).on('submit', 'form.async', function () {
                ...
                // Form Role
                if ($(this).attr('id') == 'formpenghargaan') {
                    isnew = isNew('formpenghargaan');
                    if (isnew.status) {
                        option = {
                            'module': 'penghargaan',
                            'success': {
                                ...
                                'fetch': '{{ route('api.penghargaanV2.fetch') }}',
                                'after': 300
                            }
                        }
                        sentData('{{ route('api.penghargaanV2.store') }}', option);
                    } else {
                        option = {
                            'module': 'penghargaan',
                            'method': 'put',
                        ...
                        sentData('{{ url('api/penghargaanV2') }}/' + isnew.id, option);
                    }
                }
            });
            ...
            $(document).on('click', '.btneditdata', function (event) {
                ...
                option = {
                    'success': {
                        ...
                        'modal': 'modalform',
                        'form': 'formpenghargaan',
                        'field': ['nama', 'detail'],
                    }
                }
                getData('{{ url('api/penghargaanV2') }}/' + rowid + '/edit', option);
            });
            $(document).on('click', '.btndeletedata', function (event) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        sentData('{{ url('api/penghargaanV2') }}/' + rowid, option);
                    }
                });
            });
            $(document).on('click', '.page-link', function (event) {
                ...
                loadTable('{{ route('api.penghargaanV2.fetch') }}', textserach, page);
            });
            ...
            $('#detail').summernote({
                placeholder: 'Detail penghargaan...',
                height: 230,
                dialogsInBody: true,
                callbacks: {
