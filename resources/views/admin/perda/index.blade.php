...
@section('content')
                ...
                <form id="{{$form}}" class="async">
                    ...
                    <div class="modal-body p-4">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control send" id="tahun" placeholder="contoh: 2023"
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control send" id="judul"
                                        placeholder="Judul Peraturan / tentang peraturan" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control send" id="sumber" placeholder="Sumber / LD TLD"
                                        required>
                                </div>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">No. Reg Provinsi <small>(optional)</small></label>
                                    <input type="text" class="form-control send" id="no_reg"
                                        placeholder="contoh: 13,109/2019">
                                </div>
                            </div>
                        </div>
    ...
    <div id="modalformubahcabut" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <form id="formubahcabut" class="async">
                    <div class="modal-header">
                        <h4 class="modal-title">Update Ubah/Cabut</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body p-4">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">Cabut <small>(mencabut)</small></label>
                                    <select class="form-control select2-multiple select2-ajax send" name="cabut" id="cabut"
                                        multiple="multiple" data-placeholder="Tulis Nomor atau Tentang Regulasi ...">
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">Ubah <small>(mengubah)</small></label>
                                    <select class="form-control select2-multiple select2-ajax send" name="ubah" id="ubah"
                                        multiple="multiple" data-placeholder="Tulis Nomor atau Tentang Regulasi ...">
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="keterangan" id="keteranganuc">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary waves-effect justify-start" data-dismiss="modal"><i
                                class="mdi mdi-close-thick mr-2"></i> Close</button>
                        <button type="submit" class="ladda-button btn btn-primary waves-effect waves-light" dir="ltr"
                            data-style="zoom-in" id="btnubahcabut"><i class="mdi mdi-content-save mr-2"></i> Save
                            changes</button>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        $(function ($) {
            ...
            $(document).on('submit', 'form.async', function () {
                ...
                // Form Ubah Cabut
                else if ($(this).attr('id') == 'formubahcabut') {
                    option = {
                        'module': 'ubahcabut',
                        'method': 'put',
                        'success': {
            ...
            // Reset select2 ketika menutup modal untuk mencegah duplikasi
