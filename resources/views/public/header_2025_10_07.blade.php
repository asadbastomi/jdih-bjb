...
<nav class="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark ">
    ...
    <div class="inner-navbar container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mx-auto navbar-center" id="mySidenav">
                ...
                <li class="nav-item">
                    ...
                    <ul>
                        ...
                        <li class="nav-item">
                            <a href="/galeri" class="nav-link">{{ translateIt('Galeri Foto') }}</a>
                        </li>
                        <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <ul>
                        ...
                        <li class="nav-item">
                            <a href="/keputusan-wali-kota" class="nav-link">{{ translateIt('Keputusan Wali Kota') }}</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <ul>
                        ...
                        <li class="nav-item">
                            <a href="/kegiatan/cat/workshop" class="nav-link">{{ translateIt('Bimtek/Workshop') }}</a>
                        </li>
                    </ul>
                </li>
            ...
            <li class="nav-item ">
                <a href="/faq" class="nav-link">{{ translateIt('FAQ') }}</a>
            </li>
            <li class="nav-item ">
                <a href="/sop" class="nav-link">{{ translateIt('SOP') }}</a>
            </li>
