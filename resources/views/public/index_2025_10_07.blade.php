...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <ul style="padding-left: 18px;" class="slider-terbaru">
                                @foreach ($regulasi as $r)
                                    <li class="p-1" style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">
                            ...
                            <div class="col-9">
                                <div class="text-right">
                                    ...
                                    <p class="text-white mb-1 text-truncate">
                                        {{ translateIt('Total Keputusan Wali Kota') }}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    @foreach ($kegiatan as $k)
                        <div class="col">
                            <a href="/kegiatan/{{ $k->id }}/{{ strtolower(str_replace(' ', '-', $k->judul)) }}">
                                <div class="card">
                                    <img class="card-img-top img-fluid" src="{{ $k->gambar }}" alt="JDIH BANJARBARU"
    ...
    <section class="section bg-primary text-white">
        <div class="row justify-content-center">
            <div class="col-10 col-sm-10 col-lg-8 col-xl-6">
                <div class="row">
                    <div class="col-sm">
                        <h1 class="text-white">Warga Banjarbaru, Ini <strong>Idaman Publik</strong> Anda!</h1>
                        <p class="text-white">Satu aplikasi dari <strong>JDIH Kota Banjarbaru</strong> untuk akses
                            layanan publik yang
                            efisien dan transparan.</p>
                        <div class="row">
                            <div class="col-4 col-sm-6 col-md-6 col-lg-6 col-xl-5 mb-4">
                                <a
                    ...
                    <div class="col">
                        <div>
                            <img src="https://play-lh.googleusercontent.com/L3EK240gC9UIWjdJp-s8BWSLpb47-Xv4egVeUigXfhe5jns0LkyTr5pBDRQh-SPDTko=w526-h296-rw"
                                alt="android-app-screenshoot" class="rounded"
            ...
            <div class="contact-section col-lg-9 mx-auto">
                ...
                <div class="contact-form">
                    ...
                    <form id="konsul" name="konsul" method="post">
                        ...
                        <input type="text" name="subjek" id="subjek" placeholder="Subjek Pertanyaan anda" required>
    ...
    {{-- <div class="skm">
        <div class="panel">
            ...
            <div class="toast-body" id="body-q">
                ...
                <p class="mb-0">
                    {{ translateIt('Bagaimana pendapat anda judul pelayanan aplikasi JDIH Bagian Hukum Kota
                    Banjarbaru?') }}
                </p>
                    ...
                    <div class="mt-1">
                        <div class="custom-control custom-radio">
                            <input type="radio" id="opsi1" name="jawab" class="custom-control-input send"
                                value="Sangat Baik">
                            <label class="custom-control-label" for="opsi1">{{ translateIt('Sangat Baik') }}</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input type="radio" id="opsi2" name="jawab" class="custom-control-input send" value="Baik">
                        ...
                        <div class="custom-control custom-radio">
                            <input type="radio" id="opsi3" name="jawab" class="custom-control-input send"
                                value="Cukup Baik">
                            <label class="custom-control-label" for="opsi3">{{ translateIt('Cukup Baik') }}</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input type="radio" id="opsi4" name="jawab" class="custom-control-input send"
                                value="Kurang Baik">
                            <label class="custom-control-label" for="opsi4">{{ translateIt('Kurang Baik') }}</label>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form action="" class="modal-content" id="formskm">
                <div class="modal-header">
                    <h5 class="modal-title" id="surveyPopupLabel">{{ translateIt('Survey Kepuasan Masyarakat') }}</h5>
                    <button id="surveyPopupClose" type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div id="surveyBody" class="modal-body">
                    ...
                    <div class="text-center btn-group btn-group-toggle mt-4">
                        <label class="col-sm" for="opsi4">
                            <input type="radio" name="jawab" id="opsi4" autocomplete="off" value="Kurang Baik"
                                class="send">
                            ...
                            <span>
                                {{ translateIt('Kurang Baik') }}
                            </span>
                        </label>

                        <label class="col-sm" for="opsi3">
                            <input type="radio" name="jawab" id="opsi3" autocomplete="off" value="Cukup Baik"
                                class="send">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <defs>
                                    <style>
                            ...
                            <span>
                                {{ translateIt('Cukup Baik') }}
                            </span>
                        </label>

                        <label class="col-sm" for="opsi2">
                            <input type="radio" name="jawab" id="opsi2" autocomplete="off" value="Baik" class="send">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <defs>
                                    <style>
                                        .b {
                                ...
                                <path
                                    ...
                                    style="fill:#fff" />
                                <ellipse class="e" cx="12" cy="13.938" rx="6.188" ry=".25" />
                                <ellipse class="e" cx="7.257" cy="13.938" rx=".208" ry="1.438" />
                                <ellipse class="e" cx="9.628" cy="13.938" rx=".208" ry="1.438" />
                                <ellipse class="e" cx="12" cy="13.938" rx=".208" ry="1.438" />
                                <ellipse class="e" cx="14.372" cy="13.938" rx=".208" ry="1.438" />
                                <ellipse class="e" cx="16.743" cy="13.938" rx=".208" ry="1.438" />
                            </svg>
                            <span>
                                {{ translateIt('Baik') }}
                            </span>
                        ...
                        <label class="col-sm" for="opsi1">
                            <input type="radio" name="jawab" id="opsi1" autocomplete="off" value="Sangat Baik"
                                class="send">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <defs>
                                    <style>
